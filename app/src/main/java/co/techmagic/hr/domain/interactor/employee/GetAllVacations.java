...
public class GetAllVacations extends DataUseCase<TimeOffAllRequest, List<RequestedTimeOff>, IEmployeeRepository> {

    public GetAllVacations(IEmployeeRepository iEmployeeRepository) {
