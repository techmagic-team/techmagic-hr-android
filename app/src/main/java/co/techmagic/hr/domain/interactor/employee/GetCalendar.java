...
public class GetCalendar extends DataUseCase<TimeOffAllRequest, List<CalendarInfo>, IEmployeeRepository> {

    public GetCalendar(IEmployeeRepository iEmployeeRepository) {
    ...
    protected Observable<List<CalendarInfo>> buildObservable(TimeOffAllRequest timeOffAllRequest) {
        return repository.getCalendar(timeOffAllRequest);
    }
}
