...
public class GetUserTimeOff extends DataUseCase<TimeOffRequest, List<RequestedTimeOff>, IEmployeeRepository> {


    public GetUserTimeOff(IEmployeeRepository iEmployeeRepository) {
